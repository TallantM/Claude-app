...
// Includes custom success/warning variants on top of the shadcn defaults
...
/** Small status label with color-coded variants (default, destructive, success, warning, etc.). */
